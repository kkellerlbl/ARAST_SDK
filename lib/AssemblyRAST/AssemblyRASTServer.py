...
import os
from AssemblyRAST.authclient import KBaseAuth as _KBaseAuth
...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'AssemblyRAST'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from AssemblyRAST.AssemblyRASTImpl import AssemblyRAST  # noqa @IgnorePep8
impl_AssemblyRAST = AssemblyRAST(config)
